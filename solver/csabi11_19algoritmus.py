...
def cubie_checking_just_cooler(c,db=0):
    c_check=Cube()
    c_check.cube_method_all_side_loader()
    for slice in c.l:
        for row in slice:
            for piece in row:
                c_check.dict_of_num_cubie[piece].l== c.dict_of_num_cubie[piece].l


def cubie_checking(c, pos):
    l = c.cube_method_get_cubie_pos_name_color()
    false = []
    true = []
